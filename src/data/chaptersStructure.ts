...
export const chaptersData: ChapterItemWithHero[] = [
  { 
    ...
    children: [
      ...
      { id: "prologo-03", slug: "prologo-juan-ruiz", title: "Juan Ruiz", subtitle: "Presidente del CV Guaguas", isPrologue: true, prologueImage: imgRuiz, prologueImagePosition: "center 25%" },
