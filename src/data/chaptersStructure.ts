...
export const chaptersData: ChapterItemWithHero[] = [
  { 
    ...
    children: [
      ...
      { id: "prologo-03", slug: "prologo-juan-ruiz", title: "Juan Ruiz", subtitle: "Presidente del CV Guaguas", isPrologue: true, prologueImage: imgRuiz, prologueImagePosition: "60% 25%", prologueImageScale: 1.8 },
