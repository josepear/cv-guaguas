...
<section id="hero" class="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 opacity-0 animate-fade-in-up [animation-delay:600ms]">
            <a href="<?php echo esc_url($pdf_url ?: '#'); ?>" class="btn-download btn-download-primary !bg-gold !text-[hsl(220,50%,10%)] !border-gold hover:!bg-transparent hover:!text-gold">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                </svg>
                Descargar PDF
            </a>
            <a href="<?php echo esc_url($epub_url ?: '#'); ?>" class="btn-download !bg-transparent !text-white !border-white/30 hover:!border-gold hover:!text-gold">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
